...
export class DetallePostitPage implements OnInit {
  ...
  constructor( private modalCtrl: ModalController, private alertCtrl: AlertController, private toastCtrl: ToastController, private asmsSrvc: AsmsServiceService, private strg: Storage ) { }
  ...
  async eliminar() {
    (await this.asmsSrvc.EliminarPostit(this.codigo)).subscribe((resp: any) => {
      this.presentToast(resp.message, 'light');
      this.modalCtrl.dismiss( null, 'confirm' );
    });
  }
